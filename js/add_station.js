var drop_donw_selector = '#add-station-page';

$(document).ready(function () {
    $('#add-station-page li').click(function () {
        $('#add-station-page .dropdown-toggle').text($(this).text())
    });
...
$(document).ready(function () {
    ...
    $('#add-station').click(function () {
        ...
        $.ajax({
            url: "http://tagino.ir/Pido/api/station/getStation?type=filter&ur=" + Math.random() * 1000233000,
            type: 'GET',
            ...
            if (errors.length > 0) {
                ...
                setTimeout(function () {
                    $.ajax({
                        url: "Https://tagino.ir/Pido/api/station/addStation",
                        type: 'POST',
                        data: myData,
